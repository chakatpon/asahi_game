...
const [game_url, set_game_url] = useState('');
...
function findWebView(id) {
  axios({
    ...
    if(res.data.status == "success") {
      ...
      set_game_url(res.data.game_url)
    }
  }).catch((e) => {
                          ...
                          ? <View style={styles.searchResultContainer}>
                                <View style={styles.searchResultBox}>
                                    <View style={styles.searchResultFrom}>
                                      ...
                                      <View style={styles.submitWrapper} >
                                        <TouchableOpacity style={styles.submit} onPress={() => {navigation.navigate('Game', { hasSearch: true , search_game_url: game_url, search_user_token: user_token, onNavigateBack: handleOnNavigateBack })}}>
                            ...
                            </View> : hasSearch&&<View style={styles.searchResultContainer}>
                                        <View style={styles.searchResultBox}>
                                            <View style={styles.searchResultFrom}>
                                              <View style={styles.titleForm}>
